# Generated by Django 6.0.7 on 2026-07-18 21:09
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('housing_type', models.CharField(choices=[('apartment', 'Квартира'), ('house', 'Будинок'), ('studio', 'Студія'), ('room', 'Кімната')], max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('pending', 'Очікує'), ('confirmed', 'Підтверджено'), ('cancelled', 'Скасовано'), ('completed', 'Завершено')], default='pending', max_length=20)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
